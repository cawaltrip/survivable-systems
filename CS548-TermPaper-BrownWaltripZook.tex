...
% % % % % % % % % % % % % % %
\hypersetup{
	pdftitle={Exploring Developing Methods of Addressing Faults in Data Fusion and Consensus in Autonomous Vehicles and Sensor Networks},
...
% % % % % % % % % % % % % % %
\title{Exploring Developing Methods of Addressing Faults in Data Fusion and Consensus in Autonomous Vehicles and Sensor Networks}
\author{
...
\subsection{Outline}
This paper is organized into two primary parts.  First, various fault models for autonomous vehicles and wireless networks are explored.  This transitions into the exploration and discussion of different types of agreement algorithms that could possibly be incorporated into the previously discussed fault models in domains beyond just autonomous vehicles.
